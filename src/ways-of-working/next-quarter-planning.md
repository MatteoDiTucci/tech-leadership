...
### Time appetite
Time appetite means the amount of weeks the team wants to work on an initiative.  
...
Small go-lives make it easy to decide to move to the next initiative or rather stay on the current one.  
...
- by guessing effort, the team defines the scope to be delivered in the quarter for each initiative
- The team is constantly late to deliver, or worse quality is cut to respect the timeline
